            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.imgbox}>
                    <View style={styles.imgPiker}>
                        ...
                        <Text>Driver's license: Front</Text>
                    </View>
                    <View style={styles.imgPiker}>
                        <View style={styles.img}>
                            <Image
                        ...
                        <Text>Driver's license: Back</Text>
                    ...
                    <View style={styles.imgPiker}>
                        ...
                        <Text>Selfie with driver's license</Text>
                    </View>
                </View>
                ...
                <View style={styles.btnCon}>
                    ...
                    <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate("carinfo")}>
